...
namespace Service
{
    public class PersonService : IPersonsService
    {
        ...
        public PersonResponse UpdatePerson(PersonUpdateRequest? personUpdateRequest)
        {
            ...
            Person? matchingPerson = _personsList.FirstOrDefault(temp=>temp.PersonID==personUpdateRequest.PersonID);

            if (matchingPerson == null)
            {
                throw new ArgumentException("Given person id doesn't exsist");   
            }
        ...
        public bool DeletePerson(Guid? personId)
        {
           if (personId == null)
            ...
            Person? person = _personsList.FirstOrDefault(temp => temp.PersonID == personId);
            if (person == null) return false;

            _personsList.RemoveAll(temp => temp.PersonID == personId);
            return true;
